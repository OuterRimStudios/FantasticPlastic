...
public class AQUAS_Reflection : MonoBehaviour
{
    ...
    public void OnWillRenderObject()
	{
       ...
       // reflectionCamera.transform.eulerAngles = new Vector3(0, Mathf.Clamp(reflectionCamera.transform.eulerAngles.y, -256, 256), Mathf.Clamp(reflectionCamera.transform.eulerAngles.z, -256, 256));
